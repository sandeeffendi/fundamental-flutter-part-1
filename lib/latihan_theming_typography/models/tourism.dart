...
final List<Tourism> tourismList = [
  ...
  Tourism(
    ...
    description:
        'Air Terjun Wafsarak, te`rsembunyi di pedalaman Papua, memukau pengunjung dengan keindahan alam yang masih alami dan menakjubkan. Terletak di tengah hutan hujan yang lebat, air terjun ini menawarkan pemandangan spektakuler dengan air yang jatuh dari ketinggian dan membentuk kolam air yang jernih di bawahnya. Suasana sekitar yang hijau dan segar menambah pesona tempat ini, sementara suara gemericik air yang tenang memberikan pengalaman yang menenangkan. Mencapai Air Terjun Wafsarak mungkin melibatkan petualangan melewati jalur-jalur hutan dan sungai, tetapi keindahan alam yang memukau di ujung perjalanan membuat setiap upaya terbayar. Tempat ini adalah surga tersembunyi yang mengundang para pencinta alam dan petualang untuk menjelajahi keajaiban alam Papua yang autentik.',
